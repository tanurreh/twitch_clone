...
import 'package:twitch_clone/app/config/app_id.dart';
...
import 'package:twitch_clone/app/modules/home/views/chat.dart';
...
class _BroadCastScreenState extends State<BroadCastScreen> {
  ...
  String baseUrl = "https://twitch-tutorial-server-zeepalm.herokuapp.com";
  ...
  _leaveChannel() async {
    ...
    if ('${_userController.user.uid}${_userController.user.username}' == widget.channelId) {
      await _liveSteamController.endLiveStream(widget.channelId);
    } else {
      await _liveSteamController.updateViewCount(widget.channelId, false);
    }
